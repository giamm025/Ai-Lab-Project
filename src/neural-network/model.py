...
class SignLanguageLSTM(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_classes):
        ...
        self.lstm = nn.LSTM(input_size=input_size,      
                            ...
                            num_layers=1, 
                            batch_first=True)    # serve a specificare l'ordine dei numeri nel tensore di input.
...
if __name__ == "__main__":
    ...
    num_classes = 5     # perche ora usiamo solo 5 parole (hello, book, computer, deaf, fine)
    ...
    modello_mani = SignLanguageLSTM(input_size=input_size_mani, hidden_size=hidden_size, num_classes=num_classes)
    ...
    modello_volto = SignLanguageLSTM(input_size=input_size_volto, hidden_size=hidden_size, num_classes=num_classes)
